...
#
# Usage:
#   Rscript generate_latency_charts.R [input_path] [output_path] [max_y] [max_x] [width] [height] [show_titles]
#
# Arguments:
#   input_path:  Directory containing aggregated latency CSV files (default: ./aggregated_latency)
#   output_path: Directory to save charts (default: ./charts/latency)
...
# - latency_median: median latency vs thinking time (ns)
# - latency_p95: 95th percentile latency vs thinking time (ns)
