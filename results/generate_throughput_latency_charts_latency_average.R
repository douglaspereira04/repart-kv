...
#
# Usage:
#   Rscript generate_throughput_latency_charts_latency_average.R [input_path] [output_path]
#
# Arguments:
...
output_path <- if (length(args) >= 2) args[2] else "./charts/throughput_latency_latency_average"
