...
int main() {
    std::cout << "=== METIS Graph Partitioning Example ===" << std::endl << std::endl;
    ...
    try {
        ...
        std::cout << "  Number of vertices: " << metis_graph.get_num_vertices() << std::endl;
        std::cout << "  Number of edges: " << metis_graph.get_num_edges() << std::endl;
        std::cout << std::endl;
