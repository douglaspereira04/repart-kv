...
#
# Usage:
#   Rscript generate_throughput_latency_charts_latency_average.R [input_path] [output_path] [max_y] [max_x] [width] [height] [show_titles]
#
# Arguments:
#   input_path:  Directory (default: ./aggregated_latency_latency_average)
#   output_path: Directory (default: ./charts/throughput_latency_latency_average)
...
#
# Creates two charts per (workload, storage_engine, workers, partition setting):
...
chart_opts <- parse_chart_cli_args(
  ...
  default_output = "./charts/throughput_latency_latency_average"
)
